        ...
        <div className="h-full flex flex-col space-y-6 pb-12 animate-fade-in">
            ...
            {isEditModalOpen && editingTask &&
                createPortal(
                    ...
                    >
                        <div className="bg-white rounded-2xl shadow-2xl border border-slate-200/90 w-full max-w-3xl max-h-[88vh] flex flex-col overflow-hidden animate-scale-up">
                            {/* Modal Header */}
                            <div className="p-5 border-b border-slate-100 flex items-center justify-between bg-white shrink-0">
                                ...
                                <button onClick={() => setIsEditModalOpen(false)} className="text-slate-400 hover:text-slate-600 p-1.5 rounded-lg hover:bg-slate-100 transition-colors">
                                    <X className="w-4 h-4" />
                                </button>
                            </div>
